...
const isArrayContainesString = (value) =>
	isArray(value) ? value.every((val) => isString(val)) : false;
const isArrayContainesFile = (value) =>
	isArray(value) ? value.every((val) => isFile(val) || isString(val)) : false;
