...
const Profile = () => {
  ...
  return (
    <>
    <div class="row-span-1 col-span-1 bg-white rounded-lg shadow-md overflow-hidden">
        <ToastContainer/>
        ...
        <p class="pt-2 text-lg font-semibold text-gray-50 capitalize">{`${currentUser?.first_name} ${currentUser?.last_name}`}</p>
        <p class="text-sm text-gray-100">{currentUser?.email}</p>
        <button class="mt-5" onClick={()=>{setIsOpen(true)}}>
            <div
        ...
        <div class="border-b">
            <Link href="/account/campaigns" >
                <a class="px-4 py-2 hover:bg-gray-100 flex">
                    ...
                    <svg  width="24px" height="24px" viewBox="0 0 256 158" xml:space="preserve" fill="currentColor" stroke="currentColor">
                    ...
                    <p class="text-xs text-gray-500">View your rides history</p>
                    </div>
                </a>
            </Link>
